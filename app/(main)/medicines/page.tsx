    ...
    useMemo(
      () => {
        ...
        const getTime = (
          ...
          const medicineWithCreatedAt =
            medicine as unknown as {
              createdAt?:
                | string
                | Date;
            };
    ...
    async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          /*
           * Refresh the daily chamber plan after deletion.
           */
  ...
  const handleModalSave =
    async (
      ...
      try {
        ...
        /*
         * Refresh both the Rx Box loading order and existing
         * dashboard schedule information.
         */
        window.dispatchEvent(
          new Event(
            "medicineScheduleChanged"
