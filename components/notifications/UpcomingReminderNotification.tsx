    ...
    <div className="fixed top-4 right-4 z-150 w-[min(92vw,20rem)] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-blue-100 dark:border-blue-900 overflow-hidden animate-in slide-in-from-right duration-300">
      ...
      <div className="p-4 space-y-3">
        ...
        <p className="text-gray-800 dark:text-gray-100 font-semibold text-sm">
          Your medication reminder is coming soon.
        </p>
        <div className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
          <p>
            Your <span className="font-semibold text-blue-600 dark:text-blue-300">{medicineName}</span> is scheduled at{' '}
            <span className="font-semibold dark:text-gray-100">{scheduledTime}</span> — 30 minutes from now.
          </p>
        </div>
        <p className="text-gray-500 dark:text-gray-400 text-xs">
          You may want to eat something before your medication if needed.
        </p>
        ...
        {showFoodReminder && (
          <div className="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2.5 bg-amber-50 dark:bg-amber-900/20 hover:bg-amber-100 dark:hover:bg-amber-800/80 transition-colors text-sm font-medium text-amber-800 dark:text-amber-100"
            >
            ...
            {expanded && foodContent && (
              <div className="px-3 py-3 bg-amber-50/50 dark:bg-amber-900/20 border-t border-amber-100 dark:border-amber-700 max-h-48 overflow-y-auto">
                <div className="mb-3">
